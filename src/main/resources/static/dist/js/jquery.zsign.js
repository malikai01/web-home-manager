...
;$.fn.zSign = function (options) {
    ...
    var _html = "<div class='sign' style='height:" + _s.height + "px;width:" + _s.width + "px;bottom:" + _s.offset + "px;left:" + _s.offset + "px'><img src='" + _s.img + "' draggable='false'/><button class='btn ok' >确定</button><button class='btn del' >删除</button></div>";
